...
namespace Impl {
  ...
  struct transform_type<ExecutionSpace, T1, Kokkos::complex<T2>> {
    ...
    static constexpr _TransformType m_type = std::is_same_v<T1, float> ? FFTWTransformType::R2C : FFTWTransformType::D2Z;
  ...
  struct transform_type<ExecutionSpace, Kokkos::complex<T1>, T2> {
    ...
    static constexpr _TransformType m_type = std::is_same_v<T2, float> ? FFTWTransformType::C2R : FFTWTransformType::Z2D;
    static constexpr _TransformType type() { return m_type; };
  };
  ...
  struct transform_type<ExecutionSpace, Kokkos::complex<T1>, Kokkos::complex<T2>> {
    ...
    static constexpr _TransformType m_type = std::is_same_v<T1, float> ? FFTWTransformType::C2C : FFTWTransformType::Z2Z;
    static constexpr _TransformType type() { return m_type; };
  };
