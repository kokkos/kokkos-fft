...
auto is_crop_or_pad_needed(const ViewType& view,
  ...
  static_assert(ViewType::rank() == DIM,
                "KokkosFFT::is_crop_or_pad_needed: Rank of View must be equal to Rank "
                "of extended shape.");
      ...
      range, KOKKOS_LAMBDA(int i0, int i1, int i2, int i3, int i4, int i5) {
        for(int i6=0; i6<n6; i6++) {
          for(int i7=0; i7<n7; i7++) {
            out(i0, i1, i2, i3, i4, i5, i6, i7) = in(i0, i1, i2, i3, i4, i5, i6, i7);
          }
        }
      });
}
...
void crop_or_pad(const ExecutionSpace& exec_space, const ViewType& in,
  ...
  static_assert(ViewType::rank() == DIM,
                "KokkosFFT::crop_or_pad: Rank of View must be equal to Rank "
                "of extended shape.");
