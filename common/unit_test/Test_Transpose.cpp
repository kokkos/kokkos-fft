...
TEST(Transpose, 2DLeftView) {
  ...
  EXPECT_THROW(
      KokkosFFT::Impl::transpose(execution_space(), x, xt_axis0,
                                 axes_type<2>({0, 1})),  // xt is identical to x
      std::runtime_error);

  KokkosFFT::Impl::transpose(execution_space(), x, xt_axis1,
...
TEST(Transpose, 3DLeftView) {
  ...
  LeftView3D<double> xt_axis012, xt_axis021, xt_axis102, xt_axis120, xt_axis201,
      xt_axis210;  // views are allocated internally
  LeftView3D<double> ref_axis021("ref_axis021", n0, n2, n1),
      ref_axis102("ref_axis102", n1, n0, n2);
  LeftView3D<double> ref_axis120("ref_axis120", n1, n2, n0),
...
TEST(Transpose, 3DRightView) {
  ...
  RightView3D<double> xt_axis012, xt_axis021, xt_axis102, xt_axis120,
      xt_axis201, xt_axis210;  // views are allocated internally
  RightView3D<double> ref_axis021("ref_axis021", n0, n2, n1),
      ref_axis102("ref_axis102", n1, n0, n2);
  RightView3D<double> ref_axis120("ref_axis120", n1, n2, n0),
      ref_axis201("ref_axis201", n2, n0, n1),
      ref_axis210("ref_axis210", n2, n1, n0);
