...
TEST(ModifyShape1D, View1D) {
  ...
  auto shape_pad  = KokkosFFT::Impl::get_modified_shape(x, shape_type<1>{len_pad});
  auto shape_crop = KokkosFFT::Impl::get_modified_shape(x, shape_type<1>{len_crop});
...
TEST(ModifyShape1D, View2D) {
  ...
  auto shape_pad  = KokkosFFT::Impl::get_modified_shape(x, shape_type<1>{n0_pad});
  auto shape_crop = KokkosFFT::Impl::get_modified_shape(x, shape_type<1>{n0_crop});
...
TEST(ModifyShape2D, View2D) {
  ...
  auto shape_n0_n1         = KokkosFFT::Impl::get_modified_shape(x, shape_type<2>{n0, n1});
  auto shape_n0_n1pad      = KokkosFFT::Impl::get_modified_shape(x, shape_type<2>{n0, n1_pad});
  auto shape_n0_n1crop     = KokkosFFT::Impl::get_modified_shape(x, shape_type<2>{n0, n1_crop});
  auto shape_n0pad_n1      = KokkosFFT::Impl::get_modified_shape(x, shape_type<2>{n0_pad, n1});
  auto shape_n0pad_n1pad   = KokkosFFT::Impl::get_modified_shape(x, shape_type<2>{n0_pad, n1_pad});
  auto shape_n0pad_n1crop  = KokkosFFT::Impl::get_modified_shape(x, shape_type<2>{n0_pad, n1_crop});
  auto shape_n0crop_n1     = KokkosFFT::Impl::get_modified_shape(x, shape_type<2>{n0_crop, n1});
  auto shape_n0crop_n1pad  = KokkosFFT::Impl::get_modified_shape(x, shape_type<2>{n0_crop, n1_pad});
  auto shape_n0crop_n1crop = KokkosFFT::Impl::get_modified_shape(x, shape_type<2>{n0_crop, n1_crop});
...
TEST(IsCropOrPadNeeded, View1D) {
  ...
  EXPECT_TRUE( KokkosFFT::Impl::is_crop_or_pad_needed(x, shape_type<1>{len_pad}) );
  EXPECT_TRUE( KokkosFFT::Impl::is_crop_or_pad_needed(x, shape_type<1>{len_crop}) );
}
...
TEST(CropOrPad1D, View1D) {
  ...
  View1D<double> ref_x("ref_x", len), ref_x_pad("ref_x_pad", len_pad), ref_x_crop("ref_x_crop", len_crop);
  ...
  KokkosFFT::Impl::crop_or_pad(execution_space(), x, _x_pad, shape_type<1>{len_pad});
  KokkosFFT::Impl::crop_or_pad(execution_space(), x, _x_crop, shape_type<1>{len_crop});
...
TEST(CropOrPad1D, View2D) {
  ...
  View2D<double> ref_x("ref_x", n0, n1), ref_x_pad_axis0("ref_x_pad_axis0", n0_pad, n1), ref_x_crop_axis0("ref_x_crop_axis0", n0_crop, n1);
  View2D<double> ref_x_pad_axis1("ref_x_pad_axis1", n0, n1_pad), ref_x_crop_axis1("ref_x_cro_axis1", n0, n1_crop);
  ...
  KokkosFFT::Impl::crop_or_pad(execution_space(), x, _x_pad_axis0, shape_type<2>{n0_pad, n1});
  KokkosFFT::Impl::crop_or_pad(execution_space(), x, _x_crop_axis0, shape_type<2>{n0_crop, n1});

  KokkosFFT::Impl::crop_or_pad(execution_space(), x, _x_pad_axis1, shape_type<2>{n0, n1_pad});
  KokkosFFT::Impl::crop_or_pad(execution_space(), x, _x_crop_axis1, shape_type<2>{n0, n1_crop});
...
TEST(CropOrPad1D, View3D) {
  ...
  View3D<double> x("x", n0, n1, n2);
  View3D<double> _x, _x_pad_axis0, _x_crop_axis0, _x_pad_axis1, _x_crop_axis1, _x_pad_axis2, _x_crop_axis2;
  View3D<double> ref_x("ref_x", n0, n1, n2), ref_x_pad_axis0("ref_x_pad_axis0", n0_pad, n1, n2), ref_x_crop_axis0("ref_x_crop_axis0", n0_crop, n1, n2);
  View3D<double> ref_x_pad_axis1("ref_x_pad_axis1", n0, n1_pad, n2), ref_x_crop_axis1("ref_x_cro_axis1", n0, n1_crop, n2);
  View3D<double> ref_x_pad_axis2("ref_x_pad_axis2", n0, n1, n2_pad), ref_x_crop_axis2("ref_x_cro_axis2", n0, n1, n2_crop);
  ...
  KokkosFFT::Impl::crop_or_pad(execution_space(), x, _x, shape_type<3>{n0, n1, n2});
  KokkosFFT::Impl::crop_or_pad(execution_space(), x, _x_pad_axis0, shape_type<3>{n0_pad, n1, n2});
  KokkosFFT::Impl::crop_or_pad(execution_space(), x, _x_crop_axis0, shape_type<3>{n0_crop, n1, n2});

  KokkosFFT::Impl::crop_or_pad(execution_space(), x, _x_pad_axis1, shape_type<3>{n0, n1_pad, n2});
  KokkosFFT::Impl::crop_or_pad(execution_space(), x, _x_crop_axis1, shape_type<3>{n0, n1_crop, n2});

  KokkosFFT::Impl::crop_or_pad(execution_space(), x, _x_pad_axis2, shape_type<3>{n0, n1, n2_pad});
  KokkosFFT::Impl::crop_or_pad(execution_space(), x, _x_crop_axis2, shape_type<3>{n0, n1, n2_crop});
...
TEST(CropOrPad2D, View2D) {
  ...
  View2D<double> x("x", n0, n1);
  View2D<double> _x, _x_0_1p, _x_0_1c, _x_0p_1, _x_0p_1p, _x_0p_1c, _x_0c_1, _x_0c_1p, _x_0c_1c;
  View2D<double> ref_x("ref_x", n0, n1), ref_x_0_1p("ref_x_0_1p", n0, n1_pad), ref_x_0_1c("ref_x_0_1c", n0, n1_crop);
  View2D<double> ref_x_0p_1("ref_x_0p_1", n0_pad, n1), ref_x_0p_1p("ref_x_0p_1p", n0_pad, n1_pad), ref_x_0p_1c("ref_x_0p_1c", n0_pad, n1_crop);
  View2D<double> ref_x_0c_1("ref_x_0c_1", n0_crop, n1), ref_x_0c_1p("ref_x_0c_1p", n0_crop, n1_pad), ref_x_0c_1c("ref_x_0c_1c", n0_crop, n1_crop);
  ...
  KokkosFFT::Impl::crop_or_pad(execution_space(), x, _x, shape_type<2>{n0, n1});
  KokkosFFT::Impl::crop_or_pad(execution_space(), x, _x_0_1p, shape_type<2>{n0, n1_pad});
  KokkosFFT::Impl::crop_or_pad(execution_space(), x, _x_0_1c, shape_type<2>{n0, n1_crop});
  KokkosFFT::Impl::crop_or_pad(execution_space(), x, _x_0p_1,  shape_type<2>{n0_pad, n1});
  KokkosFFT::Impl::crop_or_pad(execution_space(), x, _x_0p_1p, shape_type<2>{n0_pad, n1_pad});
  KokkosFFT::Impl::crop_or_pad(execution_space(), x, _x_0p_1c, shape_type<2>{n0_pad, n1_crop});
  KokkosFFT::Impl::crop_or_pad(execution_space(), x, _x_0c_1,  shape_type<2>{n0_crop, n1});
  KokkosFFT::Impl::crop_or_pad(execution_space(), x, _x_0c_1p, shape_type<2>{n0_crop, n1_pad});
  KokkosFFT::Impl::crop_or_pad(execution_space(), x, _x_0c_1c, shape_type<2>{n0_crop, n1_crop});
...
TEST(CropOrPad2D, View3D) {
  ...
  View3D<double> x("x", n0, n1, n2);
  View3D<double> _x, _x_0_1p, _x_0_1c, _x_0p_1, _x_0p_1p, _x_0p_1c, _x_0c_1, _x_0c_1p, _x_0c_1c;
  View3D<double> ref_x("ref_x", n0, n1, n2), ref_x_0_1p("ref_x_0_1p", n0, n1_pad, n2), ref_x_0_1c("ref_x_0_1c", n0, n1_crop, n2);
  View3D<double> ref_x_0p_1("ref_x_0p_1", n0_pad, n1, n2), ref_x_0p_1p("ref_x_0p_1p", n0_pad, n1_pad, n2), ref_x_0p_1c("ref_x_0p_1c", n0_pad, n1_crop, n2);
  View3D<double> ref_x_0c_1("ref_x_0c_1", n0_crop, n1, n2), ref_x_0c_1p("ref_x_0c_1p", n0_crop, n1_pad, n2), ref_x_0c_1c("ref_x_0c_1c", n0_crop, n1_crop, n2);
  ...
  KokkosFFT::Impl::crop_or_pad(execution_space(), x, _x, shape_type<3>{n0, n1, n2});
  KokkosFFT::Impl::crop_or_pad(execution_space(), x, _x_0_1p, shape_type<3>{n0, n1_pad, n2});
  KokkosFFT::Impl::crop_or_pad(execution_space(), x, _x_0_1c, shape_type<3>{n0, n1_crop, n2});
  KokkosFFT::Impl::crop_or_pad(execution_space(), x, _x_0p_1,  shape_type<3>{n0_pad, n1, n2});
  KokkosFFT::Impl::crop_or_pad(execution_space(), x, _x_0p_1p, shape_type<3>{n0_pad, n1_pad, n2});
  KokkosFFT::Impl::crop_or_pad(execution_space(), x, _x_0p_1c, shape_type<3>{n0_pad, n1_crop, n2});
  KokkosFFT::Impl::crop_or_pad(execution_space(), x, _x_0c_1,  shape_type<3>{n0_crop, n1, n2});
  KokkosFFT::Impl::crop_or_pad(execution_space(), x, _x_0c_1p, shape_type<3>{n0_crop, n1_pad, n2});
  KokkosFFT::Impl::crop_or_pad(execution_space(), x, _x_0c_1c, shape_type<3>{n0_crop, n1_crop, n2});
    ...
    for(int i1=-1; i1<=1; i1++) {
      for(int i2=-1; i2<=1; i2++) {
        ...
        for(int i2=0; i2<n2; i2++) {
          for(int i1=0; i1<n1; i1++) {
            for(int i0=0; i0<n0; i0++) {
              if(i0 >= h_ref_x.extent(0) || i1 >= h_ref_x.extent(1) || i2 >= h_ref_x.extent(2)) continue;
