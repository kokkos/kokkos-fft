...
In fact, these are the only APIs available in KokkosFFT (see :ref:`API reference<../api_reference>` for detail). KokkosFFT support 1D to 3D FFT over choosen axes. 
