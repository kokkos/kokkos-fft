...
function(get_tpls_list tpls_list backend_list)
  ...
  if(KokkosFFT_ENABLE_HOST_AND_DEVICE)
    ...
    if((Kokkos_ENABLE_OPENMP AND KokkosFFT_ENABLE_FFTW) AND NOT ("FFTW_OPENMP" IN_LIST tpls_list))
      list(APPEND tpls_list FFTW_OPENMP)
      list(APPEND backend_list "Host Parallel")
    elseif((Kokkos_ENABLE_THREADS AND KokkosFFT_ENABLE_FFTW) AND NOT ("FFTW_THREADS" IN_LIST tpls_list))
      list(APPEND tpls_list FFTW_THREADS)
      list(APPEND backend_list "Host Parallel")
    endif()
    if((Kokkos_ENABLE_SERIAL AND KokkosFFT_ENABLE_FFTW) AND NOT ("FFTW_SERIAL" IN_LIST tpls_list))
      list(APPEND tpls_list FFTW_SERIAL)
      list(APPEND backend_list "Host Serial")
    endif()
  endif()
